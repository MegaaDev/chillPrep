...
import { nonDsaTopics } from "../data/topics";
import { nonDsaResources } from "../data/resources";

interface NonDSATopicPageProps {
  topicId: string;
}

const NonDSATopicPage: React.FC<NonDSATopicPageProps> = ({ topicId }) => {
  const { theme } = useTheme();
  const topic = nonDsaTopics.find((t) => t.id === topicId);
  ...
  const resources = nonDsaResources.filter(
...
export default NonDSATopicPage;
